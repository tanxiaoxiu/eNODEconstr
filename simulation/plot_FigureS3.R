...
combined_plot <- wrap_plots(plot_list, ncol = 5, nrow = 1, guides = "collect") &
  theme(
    legend.position = "bottom",             
...
ggsave(filename="FigureS3c.png",plot=combined_plot,device="png",dpi=600,units="in",width=28,height=6)
